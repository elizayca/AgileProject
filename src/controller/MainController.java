...
public class MainController implements Initializable {
    ...
    @FXML
    private TableColumn<Register, Date> dateColumn2;
    @FXML
    ...
    @FXML
    private TableColumn<Register, Integer> idColumn;

    @FXML
    private TableColumn<Register, String> nameColumn;

    @FXML
    private TableColumn<Register, String> surnameColumn;

    @FXML
    private TableColumn<Register, String> departmentColumn;

    @FXML
    private TableColumn<Register, String> mailColumn;
    ...
    public ObservableList<Register> getRegistersList() {
        ...
        try {
            ...
            Register registers;
            while (rs.next()) {
                registers = new Register(rs.getInt("Number"), rs.getString("Name"), rs.getString("Surname"), rs.getString("Department"), rs.getString("Mail"), rs.getDate("Date"),rs.getDate("Date2"));
    ...
    public void showRegisters() {
        ObservableList<Register> list = getRegistersList();

        idColumn.setCellValueFactory(new PropertyValueFactory<Register, Integer>("id"));
        nameColumn.setCellValueFactory(new PropertyValueFactory<Register, String>("name"));
        surnameColumn.setCellValueFactory(new PropertyValueFactory<Register, String>("surname"));
        departmentColumn.setCellValueFactory(new PropertyValueFactory<Register, String>("department"));
        mailColumn.setCellValueFactory(new PropertyValueFactory<Register, String>("mail"));
        dateColumn.setCellValueFactory(new PropertyValueFactory<Register, Date>("date"));
        dateColumn2.setCellValueFactory(new PropertyValueFactory<Register, Date>("date2"));
...
//*************
    ...
    public void Filtering(){
        ObservableList<Register> list = getRegistersList();
        FilteredList<Register> filteredList=new FilteredList<>(list, p->true);
        ...
        SortedList<Register> sortedData = new SortedList<>(filteredList);
    ...
    public void giveAlert() {
        ObservableList<Register> list = getRegistersList();
        SortedList<Register> alertList = new SortedList<Register>(list,
                (Register date, Register date2) -> {//Sürekli kontrol edip saatte 1 tekrar uygulama açılsın.
                    if (date.getDate().toLocalDate().isEqual(LocalDate.now().plusDays(1))) {
                        ...
                        dateColumn.setCellFactory(column -> new TableCell<Register, Date>() {
                            @Override
